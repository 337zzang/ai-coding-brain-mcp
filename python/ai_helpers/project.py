...
def get_flow_instance():
    ...
    class DummyFlow:
        def __init__(self):
            ...
            self.phase_manager = DummyPhaseManager()
    ...
    class DummyTaskManager:
        ...
        def get_tasks_by_plan(self, project_id):
            return []
    ...
    class DummyPhaseManager:
        def get_phases_by_plan(self, project_id):
            return []
        
        def get_active_phase(self, project_id):
            return None
        
        def define_phase(self, plan_id, name, order, description):
            return type('obj', (object,), {'id': f'phase-{order}', 'name': name, '__dict__': {'id': f'phase-{order}', 'name': name}})
        ...
        def transition_to_next_phase(self, project_id):
            pass
    ...
    class DummyEventBus:
        ...
        def get_history(self, event_type):
            return []
