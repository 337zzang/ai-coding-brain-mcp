...
exports.handleGitStatus = handleGitStatus;
exports.handleGitCommitSmart = handleGitCommitSmart;
exports.handleGitBranchSmart = handleGitBranchSmart;
exports.handleGitRollbackSmart = handleGitRollbackSmart;
exports.handleGitPush = handleGitPush;
const logger_1 = require("../services/logger");
const logger = (0, logger_1.createLogger)('git-handlers');
/**
 * Python 스크립트 실행 헬퍼 함수
 */
async function executePythonScript(scriptPath, args, projectRoot) {
 ...
 * Git 스마트 커밋
 */
async function handleGitCommitSmart(args) {
    try {
        const path = require('path');
        const fs = require('fs');
        // 프로젝트 루트 찾기
 ...
 * Git 스마트 브랜치
 */
async function handleGitBranchSmart(args) {
    try {
        const path = require('path');
        const fs = require('fs');
 ...
 * Git 스마트 롤백
 */
async function handleGitRollbackSmart(args) {
    try {
...
`;
        const result = execSync(`python -c "import json; ${pythonCode.replace(/"/g, '\\"')}"`, {
            encoding: 'utf8',
            cwd: process.cwd(),
