...
from workflow_v2_helper import workflow_v2, get_manager
from workflow_v2_auto_tracker import get_tracker
...
def v2_done(summary: str = None) -> str:
    ...
    manager = get_manager()
    if manager.workflow.focus_task_id:
        from workflow_v2_auto_tracker import auto_complete_task
        if not summary:
            # 자동 요약 사용
